...
| `protocol/describe-user-scram-credentials.ts` | DescribeUserScramCredentials request/response codec (API key 50, v0), `buildDescribeUserScramCredentialsRequest`, `decodeDescribeUserScramCredentialsResponse`, `ScramMechanism` enum                                                                                                                                                                                                             |
| `protocol/alter-user-scram-credentials.ts`    | AlterUserScramCredentials request/response codec (API key 51, v0), `buildAlterUserScramCredentialsRequest`, `decodeAlterUserScramCredentialsResponse`                                                                                                                                                                                                                                             |     | `protocol/describe-client-quotas.ts` | DescribeClientQuotas request/response codec (API key 48, v0–v1), `buildDescribeClientQuotasRequest`, `decodeDescribeClientQuotasResponse`, `QuotaMatchType` |
| `protocol/alter-client-quotas.ts`             | AlterClientQuotas request/response codec (API key 49, v0–v1), `buildAlterClientQuotasRequest`, `decodeAlterClientQuotasResponse`                                                                                                                                                                                                                                                                  |     | `protocol/describe-groups.ts`        | DescribeGroups request/response codec (API key 15, v0–v5), `buildDescribeGroupsRequest`, `decodeDescribeGroupsResponse`                                     |
...
| `protocol/describe-cluster.ts`                | DescribeCluster request/response codec (API key 60, v0–v1), `buildDescribeClusterRequest`, `decodeDescribeClusterResponse`                                                                                                                                                                                                                                                                        |
| `protocol/describe-producers.ts`              | DescribeProducers request/response codec (API key 61, v0), `buildDescribeProducersRequest`, `decodeDescribeProducersResponse`                                                                                                                                                                                                                                                                     |
| `protocol/describe-transactions.ts`           | DescribeTransactions request/response codec (API key 65, v0), `buildDescribeTransactionsRequest`, `decodeDescribeTransactionsResponse`                                                                                                                                                                                                                                                            |
| `protocol/list-transactions.ts`               | ListTransactions request/response codec (API key 66, v0), `buildListTransactionsRequest`, `decodeListTransactionsResponse`                                                                                                                                                                                                                                                                        |
| `protocol/describe-topic-partitions.ts`       | DescribeTopicPartitions request/response codec (API key 75, v0), `buildDescribeTopicPartitionsRequest`, `decodeDescribeTopicPartitionsResponse`, paginated partition metadata                                                                                                                                                                                                                     |
| `protocol/update-features.ts`                 | UpdateFeatures request/response codec (API key 57, v0–v1), `buildUpdateFeaturesRequest`, `decodeUpdateFeaturesResponse`                                                                                                                                                                                                                                                                           |
| `protocol/describe-quorum.ts`                 | DescribeQuorum request/response codec (API key 55, v0–v1), `buildDescribeQuorumRequest`, `decodeDescribeQuorumResponse`, KRaft quorum state                                                                                                                                                                                                                                                       |
| `protocol/consumer-group-heartbeat.ts`        | ConsumerGroupHeartbeat request/response codec (API key 68, v0), `buildConsumerGroupHeartbeatRequest`, `decodeConsumerGroupHeartbeatResponse`, KIP-848 new consumer group protocol                                                                                                                                                                                                                 |
| `protocol/consumer-group-describe.ts`         | ConsumerGroupDescribe request/response codec (API key 69, v0), `buildConsumerGroupDescribeRequest`, `decodeConsumerGroupDescribeResponse`, KIP-848 group description with member assignments                                                                                                                                                                                                      |
| `protocol/get-telemetry-subscriptions.ts`     | GetTelemetrySubscriptions request/response codec (API key 71, v0), `buildGetTelemetrySubscriptionsRequest`, `decodeGetTelemetrySubscriptionsResponse`, KIP-714 client telemetry                                                                                                                                                                                                                   |
| `protocol/push-telemetry.ts`                  | PushTelemetry request/response codec (API key 72, v0), `buildPushTelemetryRequest`, `decodePushTelemetryResponse`, KIP-714 client telemetry push                                                                                                                                                                                                                                                  |
...
| `src/protocol/`      | Kafka API request/response codecs (46 APIs)                       |
...
- [x] DescribeUserScramCredentials request/response codec (API key 50, v0–v0)
- [x] AlterUserScramCredentials request/response codec (API key 51, v0–v0)
- [x] Add SCRAM credential methods to `KafkaAdmin`

Acceptance: Codecs round-trip correctly, admin client can manage SCRAM users.

### Client Quota APIs

- [x] DescribeClientQuotas request/response codec (API key 48, v0–v1)
- [x] AlterClientQuotas request/response codec (API key 49, v0–v1)
- [x] Add quota methods to `KafkaAdmin`

Acceptance: Codecs round-trip correctly, admin client can inspect and set client quotas.

### Log Dir APIs

- [x] DescribeLogDirs request/response codec (API key 35, v0–v4)
- [x] AlterReplicaLogDirs request/response codec (API key 34, v0–v2)
- [x] Add log dir methods to `KafkaAdmin`
...
- [x] DescribeCluster request/response codec (API key 60, v0–v1)
- [x] DescribeProducers request/response codec (API key 61, v0–v0)
- [x] DescribeTransactions request/response codec (API key 65, v0–v0)
- [x] ListTransactions request/response codec (API key 66, v0–v0)
- [x] DescribeTopicPartitions request/response codec (API key 75, v0–v0)
- [x] UpdateFeatures request/response codec (API key 57, v0–v1)
- [x] DescribeQuorum request/response codec (API key 55, v0–v1)
- [x] Add discovery and introspection methods to `KafkaAdmin`
