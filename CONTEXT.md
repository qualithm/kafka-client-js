...
| `client/admin.ts`                      | `KafkaAdmin` class with topic/partition management, config describe/alter, topic listing via Metadata, retry with exponential backoff, `createAdmin` factory                                                                                                                                                                           |
