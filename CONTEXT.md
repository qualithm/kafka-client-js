...
| `protocol/alter-user-scram-credentials.ts`    | AlterUserScramCredentials request/response codec (API key 51, v0), `buildAlterUserScramCredentialsRequest`, `decodeAlterUserScramCredentialsResponse`                                                                                                                                                                                                                                             |
