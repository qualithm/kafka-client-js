...
[![CI](https://github.com/qualithm/kafka-client-js/actions/workflows/ci.yaml/badge.svg?branch=main)](https://github.com/qualithm/kafka-client-js/actions/workflows/ci.yaml)
